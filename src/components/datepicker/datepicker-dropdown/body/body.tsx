...
const Body = ({ onNext, onPrev, headerText, children, onNextDouble, onPrevDouble, onClick }: IProps) => {
  return (
...
export const CaretIcon = ({ color = '#FFF', width = '25px', height = '25px' }: IProps) => {
  return (
    <svg width={width} height={height} viewBox="-5 0 25 25" version="1.1" xmlns="http://www.w3.org/2000/svg">
